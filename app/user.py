...
async def cmd_start(message: Message):
    ...
    await message.answer(f'Здравствуйте, <b>{message.from_user.first_name}</b>\n\n'
                         ...
                         f'<b>Этот бот создан для улучшения ЧР вместе с вами. Здесь можно сообщить о проблемах городской инфраструктуры:</b>\n'
                         f'<b>• Разбитые дороги 🚧\n'
...
async def cmd_help(message: Message):
    ...
    await message.answer('<b>ℹ️ Справка по боту "Городской ключ"</b>\n\n'
                         'Этот бот создан для оперативного реагирования на проблемы городской инфраструктуры городов чеченской Ркспублики. Вот что он умеет:\n\n'
